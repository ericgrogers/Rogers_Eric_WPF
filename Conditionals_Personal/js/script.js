...
// otherwise, continue.	
	...
	// output vacationPrice, monthsToSave(rounded) and spendingMoney totals and save it to the results variable. 
	results = "For the $" + vacationPrice + " vacation package, you will need to save for approximately " + Math.round(monthsToSave) + " months in order to have enough for the vacation with $" + spendingMoney + " in spending money.";
}
